...
/** The ODP-IP (Integer-Partition based) algorithm for Coalition Structure Generation (CSG) and complete set partitioning
 * @author Talal Rahwan
 */
//
//Note: If you use function "Z" to compute the number of CS, then it will overlap for more than 25 agents, in
//      this case, use the BigInteger version (I don't use it in this code! so don't run for more than 25 agents)
//
//NOTE: The number of expansions (in the space of coalition structures) overlaps for more than 24 agents
//
...
public class IPSolver
{
	...
	public void solve( Input input, Output output, Result result )
	{
		...
		//Create the integer partition graph: (1) put all nodes, (2) decide which edges to put; if you put 1 then no edges will be added
		...
		//Initialize the table used in the technique called: "local branch and bound"
		...
		//Prepare the ODP solver if it is required to run in parallel with IP
