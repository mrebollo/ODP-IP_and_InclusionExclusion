...
public class MainFrame extends JFrame
{
	...
	private void jbInit() throws Exception
	{
		...
		runInclusionExclusion_radioButton.setBounds(new Rectangle(6, 135, 270,22));
		...
		runCplex_radioButton.setBounds(new Rectangle(6, 160, 270,22));
		...
		jPanel5.setBounds(new Rectangle(650, 440, 315, 95));
		jPanel5.setBorder(BorderFactory.createEtchedBorder());
		jPanel5.setLayout(null);	

		jLabel11.setText("    Printing options");
		jLabel11.setBounds(new Rectangle(660, 430, 107, 18));
		...
		jPanel9.setBounds(new Rectangle(650, 555, 315, 68));
		jPanel9.setBorder(BorderFactory.createEtchedBorder());
		jPanel9.setLayout(null);
		
		jLabel7.setText("    IP & ODP-IP options    ");
		jLabel7.setBounds(new Rectangle(660, 545, 128, 18));
