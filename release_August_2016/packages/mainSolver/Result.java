...
public class Result
{
	...
	public long     inclusionExclusionTime; // only relevant when running Inclusion-Exclusion
	
	public double   inclusionExclusionTime_confidenceInterval; // the error when averaging over multiple instances
	
	public  int[][] inclusionExclusionBestCSFound; // only relevant when running Inclusion-Exclusion
	
	public  double  inclusionExclusionValueOfBestCSFound; // only relevant when running Inclusion-Exclusion
	
	public double   inclusionExclusionValueOfBestCSFound_confidenceInterval; // the error when averaging over multiple instances
	...
	private  boolean dpHasFinished; // becomes true when dp has finished
